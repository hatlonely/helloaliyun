...
def put_project(endpoint, access_key_id, access_key_secret, proj, region_id):
...
def list_projects(endpoint, access_key_id, access_key_secret, region_id):
...
def get_project(endpoint, access_key_id, access_key_secret, proj, region_id):
...
def del_project(endpoint, access_key_id, access_key_secret, proj, region_id):
